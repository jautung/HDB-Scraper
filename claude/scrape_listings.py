...
from hdb_common import HEADERS, PHOTO_BASE_URL, LISTING_URL_TEMPLATE, new_session, post_json
...
def fetch_all_listings(payload=None, session=None, retries=4, backoff=2.0, timeout=30, debug=False):
    ...
    data = post_json(sess, API_URL, payload, retries=retries, backoff=backoff, timeout=timeout, debug=debug)
